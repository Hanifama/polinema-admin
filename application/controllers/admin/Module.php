...
class Module extends CI_Controller {
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$primary_keys['communities'] = 'community_id';
			$primary_keys['articles'] = 'article_id';
			$primary_keys['community_categories'] = 'category_id';
			$primary_keys['discussion'] = 'discus_id';
			$primary_keys['discussion_comment'] = 'comment_id';
			$primary_keys['events'] = 'event_id';
			$primary_keys['posts'] = 'post_id';
			$primary_keys['tenant_categories'] = 'tencat_id';
            $primary_keys['tenants'] = 'tenant_id';
            $primary_keys['users'] = 'user_id';
            $primary_keys['vouchers'] = 'voucher_id';
			$primary_keys['voucher_categories'] = 'vocat_id';
			$primary_keys['banner'] = 'banner_id';
			$primary_keys['banner_tenant'] = 'banner_id';
			$primary_keys['events'] = 'event_id';
			$primary_keys['programs'] = 'program_id';
			$primary_keys['departments'] = 'department_id';
			$primary_keys['post_comments'] = 'commment_id';
...
////////////////////////////////////////////////////
	...
	<div class="form-group mb-3">
	  <label for="' . $value . '" class="col-sm-3 form-label"> ' . ucfirst($value) . ' </label>
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="' . $value . '" name="' . $value . '" value="<?php echo set_value("' . $value . '"); ?>" >
	  </div>
	  <div class="col-sm-6" >
...
////////////////////////////////////////////////////
	...
	<!-- ' . ucfirst($value) . ' Start -->
	<div class="form-group mb-3">
        <label class="form-label col-md-3"> ' . ucfirst($value) . ' </label>
        <div class="col-md-4">
...
////////////////////////////////////////////////////
 ...
 <div class="form-group mb-3">
          ...
          <label class="col-sm-3 form-label">Select ' . ucfirst($value) . '</label>
...
////////////////////////////////////////////////////
    ...
    <div class="form-group mb-3">
      <label for="address" class="col-sm-3 form-label"> ' . ucfirst($value) . ' </label>
      <div class="col-sm-6">
...
<div class="form-group mb-3">
  <label for="' . $value . '" class="col-sm-3 form-label"> ' . ucfirst($value) . ' </label>
  <div class="col-sm-6">
    <input type="text" class="form-control" id="' . $value . '" name="' . $value . '" value="<?php echo set_value("' . $value . '",html_entity_decode($' . $table . '->' . $value . ')); ?>">
  </div>
  <div class="col-sm-4" >
    <?php echo form_error("' . $value . '","<span class=singlequotelabel label-dangersinglequote>","</span>")?>
  </div>
...
<div class="form-group mb-3">
  <label for="' . $value . '" class="col-sm-3 form-label"> ' . ucfirst($value) . ' </label>
  <div class="col-sm-6">
    <input type="text" class="form-control span2 datepicker" id="' . $value . '" name="' . $value . '" value="<?php echo set_value("' . $value . '",$' . $table . '->' . $value . '); ?>">
  </div>
  <div class="col-sm-4" >
    <?php echo form_error("' . $value . '","<span class=singlequotelabel label-dangersinglequote>","</span>")?>
  </div>
...
////////////////////////////////////////////////////
	...
	<!-- ' . ucfirst($value) . ' Start -->
	 ...
	 <div class="form-group mb-3">
        ...
        <label class="form-label col-md-3">' . $value . '
...
////////////////////////////////////////////////////
	...
	<tr>
	 ...
	 <td>
	  ...
	  <label class="col-sm-3 form-label">' . ucfirst($value) . '</label>
            ...
            if ($_POST["multiselect"]["table"][$i]) {
                ...
                <tr>
                 ...
                 <td>
                  ...
                  <label for="address" class="col-sm-3 form-label"> ' . ucfirst($rtable) . ' </label>
...
//////////////////////////////////////////////////////////////////////////
            ...
            $tabledatarows .= '<th class="action-width btn-group">

		   <a href="<?php echo base_url()?>admin/' . $table_new . '/view/<?php echo @@@value->'.$primary_key.'; ?>" class="btn btn-info" title="View">
            <i class="fa fa-eye"></i>
           </a>
           <a href="<?php echo base_url()?>admin/' . $table_new . '/edit/<?php echo @@@value->'.$primary_key.'; ?>" class="btn btn-info" title="Edit">
            <i class="fa fa-edit"></i>
           </a>
           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info" onclick="set_common_delete(\'<?php echo @@@value->'.$primary_key.'; ?>\',\'' . $table_new . '\');">
...
//////////////////////////////////////////////////////////////////////////
           ...
           <a href="<?php echo base_url()?>admin/' . $table_new . '/view/<?php echo @@@value->'.$primary_key.'; ?>/<?php echo @@@rel_field; ?>/<?php echo @@@rel_id; ?>" class="btn btn-info " title="View">
            <i class="fa fa-eye"></i>
           </a>
           <a href="<?php echo base_url()?>admin/' . $table_new . '/edit/<?php echo @@@value->'.$primary_key.'; ?>/<?php echo @@@rel_field; ?>/<?php echo @@@rel_id; ?>" class="btn btn-info " title="Edit">
            <i class="fa fa-edit"></i>
           </a>
           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info " onclick="set_common_delete(\'<?php echo @@@value->'.$primary_key.'; ?>\',\'' . $table_new . '\');">
           <i class="fa fa-trash-o "></i>
  ...
  <th>Date Time</th>
    ...
    function get_key_dropdown() {
        ...
        ?>
            ...
            <label for="Module_name" class="col-sm-3 form-label"> Related Field </label>
