...
class About_us_model extends CI_Model
{
  ...
  public $v_fields=array('about_id', 'title', 'banner', 'content', 'cheese_industry_experience', 'featured_cheese_products');
  ...
  function getRow($table, $id) {
    $this->db->select('*');
    $query = $this->db->get_where($table, array('about_id' => $id));
    $data = $query->result();
