...
class Banner_tenant_model extends CI_Model
{

  public $v_fields=array('banner_id', 'image', 'date_from', 'date_to', 'status');
  ...
  function getRow($table, $id) {
    $this->db->select('*');
    $query = $this->db->get_where($table, array('banner_id' => $id));
    $data = $query->result();
