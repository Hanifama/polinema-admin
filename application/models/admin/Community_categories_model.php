...
class Community_categories_model extends CI_Model
{

  public $v_fields=array('category_id', 'name', 'photo', 'created_dt');
  ...
  function getRow($table, $id) {
    $this->db->select('*');
    $query = $this->db->get_where($table, array('category_id' => $id));
    $data = $query->result();
