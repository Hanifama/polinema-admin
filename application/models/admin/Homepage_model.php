...
class Homepage_model extends CI_Model
{
  ...
  public $v_fields=array('youtube_thumb', 'youtube_link', 'socmed_youtube', 'socmed_tiktok', 'socmed_instagram', 'socmed_facebook', 'email_cs', 'feature_1', 'feature_2', 'feature_3', 'feature_4', 'feature_5', 'feature_1_image', 'feature_2_image', 'feature_3_image', 'feature_4_image', 'feature_5_image', 'teknologi_image', 'teknologi_icon', 'teknologi_title', 'teknologi_text', 'banner_bottom_img', 'banner_bottom_url', 'contact_email', 'contact_phone', 'contact_address', 'is_maintenance');
