...
class Product_model extends CI_Model
{
  ...
  public $v_fields=array('product_id', 'name', 'thumbnail', 'image_1', 'image_2', 'image_3', 'image_4', 'image_5', 'description', 'categories', 'tag', 'status', 'data', 'shelf_life', 'md_number', 'halal_certificate', 'storage_suggestion', 'serving_suggestion');
  ...
  function getRow($table, $id) {
    $this->db->select('*');
    $query = $this->db->get_where($table, array('product_id' => $id));
    $data = $query->result();
