...
class Tenant_categories_model extends CI_Model
{

  public $v_fields=array('tencat_id', 'name', 'icon', 'status');
	...
	function getList($table, $pagination=array()) 
  {
    ...
    $this->db->order_by("tencat_id","desc");
    $query = $this->db->get();
  ...
  function getRow($table, $id) {
    $this->db->select('*');
    $query = $this->db->get_where($table, array('tencat_id' => $id));
    $data = $query->result();
