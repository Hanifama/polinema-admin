...
class Voucher_categories_model extends CI_Model
{

  public $v_fields=array('vocat_id', 'name', 'icon', 'description', 'created_dt');
	...
	function getList($table, $pagination=array()) 
  {
    ...
    $this->db->order_by("vocat_id","desc");
    $query = $this->db->get();
  ...
  function getRow($table, $id) {
    $this->db->select('*');
    $query = $this->db->get_where($table, array('vocat_id' => $id));
    $data = $query->result();
