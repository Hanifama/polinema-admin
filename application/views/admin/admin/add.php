						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="active" name="active" value="<?php echo set_value("active"); ?>">
							...
							<!-- First_name End -->							<!-- Last_name Start -->
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="company_id" name="company_id" value="<?php echo set_value("company_id"); ?>">
							...
							<!-- Company_id End -->							<!-- Type_user Start -->
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="type_user" name="type_user" value="<?php echo set_value("type_user"); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="role_id" name="role_id" value="<?php echo set_value("role_id"); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="store_id" name="store_id" value="<?php echo set_value("store_id"); ?>">
