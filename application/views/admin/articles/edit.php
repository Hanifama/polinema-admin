          ...
          <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group mb-3" style="display:none">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="article_id" name="article_id" readonly value="<?php echo set_value("article_id", html_entity_decode($articles->article_id)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                <label for="published_dt" class="col-sm-3 form-label"> Published </label>
                <div class="col-sm-6">
