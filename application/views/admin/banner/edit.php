...
<div class="form-group mb-3" style="display:none">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" id="banner_id" name="banner_id" readonly value="<?php echo set_value("banner_id",html_entity_decode($banner->banner_id)); ?>">
  </div>
  <div class="col-sm-4" >
...
<!-- Banner_id End -->
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $banner->image; ?>" alt="pic" width="50" height="50" />
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control " id="date_from" name="date_from" value="<?php echo set_value("date_from",$banner->date_from); ?>">
  </div>
  <div class="col-sm-4" >
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control " id="date_to" name="date_to" value="<?php echo set_value("date_to",$banner->date_to); ?>">
  </div>
  <div class="col-sm-4" >
...
<!-- Date_to End -->
	 ...
	 <div class="form-group mb-3">
	          ...
	          <div class="col-sm-6">
	            ...
	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $banner->status=="active"?'checked="checked"':""; ?> name="status" value="active"> active </span>

	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $banner->status=="inactive"?'checked="checked"':""; ?> name="status" value="inactive"> inactive </span>
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <textarea class="form-control" id="content" name="content"><?php echo set_value("content",html_entity_decode($banner->content)); ?></textarea>
  </div>
  <div class="col-sm-4" >
