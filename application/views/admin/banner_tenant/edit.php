...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" id="banner_id" name="banner_id" value="<?php echo set_value("banner_id",html_entity_decode($banner_tenant->banner_id)); ?>">
  </div>
  <div class="col-sm-4" >
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control span2 datepicker" id="date_from" name="date_from" value="<?php echo set_value("date_from",$banner_tenant->date_from); ?>">
  </div>
  <div class="col-sm-4" >
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control span2 datepicker" id="date_to" name="date_to" value="<?php echo set_value("date_to",$banner_tenant->date_to); ?>">
  </div>
  <div class="col-sm-4" >
...
<!-- Date_to End -->
	 ...
	 <div class="form-group mb-3">
	          ...
	          <div class="col-sm-6">
	            ...
	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $banner_tenant->status=="active"?'checked="checked"':""; ?> name="status" value="active"> active </span>

	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $banner_tenant->status=="inactive"?'checked="checked"':""; ?> name="status" value="inactive"> inactive </span>
