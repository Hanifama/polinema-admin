   ...
   <div class="col-lg-12">
      <div class="ibox card mt-3 ">
         ...
         <div class="ibox-title card-header">
            ...
            <a href="<?php echo base_url(); ?>admin/banner_tenant/add" class="btn btn-info m-2">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url().'admin/banner_tenant/index'; ?>" class="form-inline ibox-content">
               <div class="form-group m-2">
                  <select name="searchBy" class="form-control">
                  <option value="banner_id" <?php echo $searchBy=="banner_id"?'selected="selected"':""; ?>>Banner_id</option><option value="image" <?php echo $searchBy=="image"?'selected="selected"':""; ?>>Image</option><option value="date_from" <?php echo $searchBy=="date_from"?'selected="selected"':""; ?>>Date_from</option><option value="date_to" <?php echo $searchBy=="date_to"?'selected="selected"':""; ?>>Date_to</option><option value="status" <?php echo $searchBy=="status"?'selected="selected"':""; ?>>Status</option>
                  </select>
               </div>
         ...
         <div class="ibox-content card-body">
            <div class="table table-responsive">
               <table class="table table-striped table-bordered table-hover Tax" style="font-size: 13px;" >
				...
				<?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="banner_id"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>

				<th> <a href="<?php echo $fields_links["banner_id"]; ?>" class="link_css"> Banner_id <?php echo $symbol ?></a></th>
				...
				<th> <a href="<?php echo $fields_links["date_from"]; ?>" class="link_css"> Date_from <?php echo $symbol ?></a></th>
				...
				<th> <a href="<?php echo $fields_links["date_to"]; ?>" class="link_css"> Date_to <?php echo $symbol ?></a></th>
            ...
            <th><?php if(!empty($value->banner_id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->banner_id)){ echo $value->banner_id; }?></th>
		   ...
		   <a href="<?php echo base_url()?>admin/banner_tenant/view/<?php echo $value->banner_id; ?>" class="btn btn-info" title="View">
            <i class="fa fa-eye"></i>
           </a>
           <a href="<?php echo base_url()?>admin/banner_tenant/edit/<?php echo $value->banner_id; ?>" class="btn btn-info" title="Edit">
            <i class="fa fa-edit"></i>
           </a>
           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info" onclick="set_common_delete('<?php echo $value->banner_id; ?>','banner_tenant');">
...
<script type="text/javascript">
   ...
   function delRow()
   {
      ...
      if(confrm)
      {
         ...
         $.ajax({
         type:"POST",
         url:'<?php echo base_url()."admin/banner_tenant/deleteAll"; ?>',
         data:{
            allIds : ids,
