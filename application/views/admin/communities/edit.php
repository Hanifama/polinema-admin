        ...
        <div class="box box-info">
          ...
          <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <?php endif; ?>              <!-- Community_id Start -->

              <div class="form-group mb-3" style="display:none">
                <label for="community_id" class="col-sm-3 form-label" > ID </label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="community_id" readonly name="community_id" value="<?php echo set_value("community_id", html_entity_decode($communities->community_id)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="name" name="name" value="<?php echo set_value("name", html_entity_decode($communities->name)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" id="description" name="description"><?php echo set_value("description", html_entity_decode($communities->description)); ?></textarea>
                </div>
                <div class="col-sm-4">
                  ...
                  <select class="form-control select2" name="category_id" id="category_id">
                    ...
                    if (isset($community_categories) && !empty($community_categories)):
                      ...
                      foreach ($community_categories as $key => $value): ?>
                        <option value="<?php echo $value->category_id; ?>" <?php echo $value->category_id == $communities->category_id ? 'selected="selected"' : ""; ?>>
                          <?php echo $value->name; ?>
                        </option>
                      <?php endforeach; ?>
                    <?php endif; ?>
