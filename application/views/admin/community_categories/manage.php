   ...
   <div class="col-lg-12">
      <div class="ibox card mt-3 ">
         ...
         <div class="ibox-title card-header">
            ...
            <a href="<?php echo base_url(); ?>admin/community_categories/add" class="btn btn-info m-2">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url() . 'admin/community_categories/index'; ?>" class="form-inline ibox-content">
               ...
               <table class="table table-striped table-bordered table-hover Tax" style="font-size: 13px;">
                  ...
                  <tbody>
                     ...
                     ?>
                        ...
                        ?>
                           <tr id="hide<?php echo $value->category_id; ?>">
                              <th><input name='input' id='del' onclick="callme('show')" type='checkbox' class='del' value='<?php echo $value->category_id; ?>' /></th>
                              ...
                              <th class="action-width btn-group">
                                 ...
                                 <a href="<?php echo base_url() ?>admin/community_categories/edit/<?php echo $value->category_id; ?>" class="btn btn-info" title="Edit">
                                    <i class="fa fa-edit"></i>
                                 </a>
                                 <a title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info" onclick="set_common_delete('<?php echo $value->category_id; ?>','community_categories');">
...
<script type="text/javascript">
   function delRow() {
      ...
      if (confrm) {
         ...
         $.ajax({
            type: "POST",
            url: '<?php echo base_url() . "admin/community_categories/deleteAll"; ?>',
            data: {
               allIds: ids,
