   ...
   <div class="col-lg-12">
      <div class="ibox card mt-3 ">
         ...
         <div class="ibox-title card-header">
            ...
            <a href="<?php echo base_url(); ?>admin/departments/add" class="btn btn-info m-2">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url().'admin/departments/index'; ?>" class="form-inline ibox-content">
               <div class="form-group m-2">
                  <select name="searchBy" class="form-control">
                  <option value="department_id" <?php echo $searchBy=="department_id"?'selected="selected"':""; ?>>ID</option><option value="name" <?php echo $searchBy=="name"?'selected="selected"':""; ?>>Name</option>
                  </select>
               </div>
         ...
         <div class="ibox-content card-body">
				...
				<th> <a href="<?php echo $fields_links["created_dt"]; ?>" class="link_css"> Created <?php echo $symbol ?></a></th>
                  ...
                  <tbody>
                     ...
                     <?php 
                        ...
                        ?>
                     <tr  id="hide<?php echo $value->department_id; ?>" >
                     <th><input name='input' id='del' onclick="callme('show')"  type='checkbox' class='del' value='<?php echo $value->department_id; ?>'/></th>

                              

            <th><?php if(!empty($value->department_id)){ echo $count; $count++; }?></th>
           ...
           <a href="<?php echo base_url()?>admin/departments/edit/<?php echo $value->department_id; ?>" class="btn btn-info" title="Edit">
            <i class="fa fa-edit"></i>
           </a>
           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info" onclick="set_common_delete('<?php echo $value->department_id; ?>','departments');">
...
<script type="text/javascript">
   ...
   function delRow()
   {
      ...
      if(confrm)
      {
         ...
         $.ajax({
         type:"POST",
         url:'<?php echo base_url()."admin/departments/deleteAll"; ?>',
         data:{
            allIds : ids,
