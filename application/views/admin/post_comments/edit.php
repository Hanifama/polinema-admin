          ...
          <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="comment_id" name="comment_id" value="<?php echo set_value("comment_id", html_entity_decode($post_comments->comment_id)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-md-4">
                  <select class="form-control select2" name="post_id" id="post_id">
                    <option value="">select Post_id</option>
                    <?php

                    if (isset($posts) && !empty($posts)):

                      foreach ($posts as $key => $value): ?>
                        <option value="<?php echo $value->post_id; ?>" <?php echo $value->post_id == $post_comments->post_id ? 'selected="selected"' : ""; ?>>
                  ...
                  <select class="form-control select2" name="user_id" id="user_id">
                    ...
                    if (isset($users) && !empty($users)):
                      ...
                      foreach ($users as $key => $value): ?>
                        <option value="<?php echo $value->user_id; ?>" <?php echo $value->user_id == $post_comments->user_id ? 'selected="selected"' : ""; ?>>
                          <?php echo $value->name; ?>
                        </option>
                      <?php endforeach; ?>
                    <?php endif; ?>
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" id="content" name="content"><?php echo set_value("content", html_entity_decode($post_comments->content)); ?></textarea>
                </div>
                <div class="col-sm-4">
              ...
              <!-- Content End --> <!-- Created Start -->

              <div class="form-group mb-3">
                <label for="created_dt" class="col-sm-3 form-label"> Created </label>
                <div class="col-sm-6">
                  <input type="text" class="form-control datetimepicker" name="created_dt" id="created_dt" value="<?php echo set_value("created_dt", $post_comments->created_dt); ?>" />
                </div>
                <div class="col-sm-4">
