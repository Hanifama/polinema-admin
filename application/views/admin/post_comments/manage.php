   ...
   <div class="col-lg-12">
      <div class="ibox card mt-3 ">
         ...
         <div class="ibox-title card-header">
            ...
            <a href="<?php echo base_url(); ?>admin/post_comments/add" class="btn btn-info m-2">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url().'admin/post_comments/index'; ?>" class="form-inline ibox-content">
               <div class="form-group m-2">
                  <select name="searchBy" class="form-control">
                  <option value="comment_id" <?php echo $searchBy=="comment_id"?'selected="selected"':""; ?>>ID</option><option value="posts.post_id" <?php echo $searchBy=="posts.post_id"?'selected="selected"':""; ?>>Post_id</option><option value="users.name" <?php echo $searchBy=="users.name"?'selected="selected"':""; ?>>User_id</option><option value="content" <?php echo $searchBy=="content"?'selected="selected"':""; ?>>Content</option><option value="created_dt" <?php echo $searchBy=="created_dt"?'selected="selected"':""; ?>>Created</option>
                  </select>
               </div>
         ...
         <div class="ibox-content card-body">
            <div class="table table-responsive">
               <table class="table table-striped table-bordered table-hover Tax" style="font-size: 13px;" >
				...
				<?php
				 ...
				 $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="posts.post_id"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>
				<th> <a href="<?php echo $fields_links["posts.post_id"]; ?>" class="link_css"> Post ID <?php echo $symbol ?></a></th>
		   ...
		   <!--a href="<?php echo base_url()?>admin/post_comments/view/<?php echo $value->comment_id; ?>" class="btn btn-info" title="View">
            <i class="fa fa-eye"></i>
           </a>
           <a href="<?php echo base_url()?>admin/post_comments/edit/<?php echo $value->comment_id; ?>" class="btn btn-info" title="Edit">
...
<script type="text/javascript">
   ...
   function delRow()
   {
      ...
      if(confrm)
      {
         ...
         $.ajax({
         type:"POST",
         url:'<?php echo base_url()."admin/post_comments/deleteAll"; ?>',
         data:{
            allIds : ids,
