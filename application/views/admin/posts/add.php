          ...
          <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group mb-3" style="display:none">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="post_id" name="post_id" readonly value="<?php echo md5(uniqid(mt_rand(), true)) ?>">
                </div>
                <div class="col-sm-6">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="privacy" value="public"> public </span>

                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="privacy" value="private"> private </span>
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <span style="margin-right:20px;"><input type="checkbox" style="width:20px; height:20px;" name="replied[]" value="1"> 1 </span>

                  <span style="margin-right:20px;"><input type="checkbox" style="width:20px; height:20px;" name="replied[]" value="0"> 0 </span>
