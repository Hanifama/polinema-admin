   ...
   <div class="col-lg-12">
      <div class="ibox card mt-3 ">
         ...
         <div class="ibox-title card-header">
            ...
            <a href="<?php echo base_url(); ?>admin/programs/add" class="btn btn-info m-2">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url().'admin/programs/index'; ?>" class="form-inline ibox-content">
               <div class="form-group m-2">
                  <select name="searchBy" class="form-control">
                  <option value="departments.name" <?php echo $searchBy=="departments.name"?'selected="selected"':""; ?>>Department</option><option value="name" <?php echo $searchBy=="name"?'selected="selected"':""; ?>>Name</option>
                  </select>
               </div>
         ...
         <div class="ibox-content card-body">
            <div class="table table-responsive">
               <table class="table table-striped table-bordered table-hover Tax" style="font-size: 13px;" >
				...
				<?php
				 ...
				 $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="departments.name"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>



				<th> <a href="<?php echo $fields_links["departments.name"]; ?>" class="link_css"> Department <?php echo $symbol ?></a></th>
				...
				<th> <a href="<?php echo $fields_links["created_dt"]; ?>" class="link_css"> Created <?php echo $symbol ?></a></th>
                  ...
                  <tbody>
                     ...
                     <?php 
                        ...
                        ?>
                     <tr  id="hide<?php echo $value->program_id; ?>" >
                     <th><input name='input' id='del' onclick="callme('show')"  type='checkbox' class='del' value='<?php echo $value->program_id; ?>'/></th>

                              

            <th><?php if(!empty($value->program_id)){ echo $count; $count++; }?></th>

                <th><?php if(!empty($value->department_id)){ echo $value->department_id; }?></th>
           ...
           <a href="<?php echo base_url()?>admin/programs/edit/<?php echo $value->program_id; ?>" class="btn btn-info" title="Edit">
            <i class="fa fa-edit"></i>
           </a>
           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info" onclick="set_common_delete('<?php echo $value->program_id; ?>','programs');">
...
<script type="text/javascript">
   ...
   function delRow()
   {
      ...
      if(confrm)
      {
         ...
         $.ajax({
         type:"POST",
         url:'<?php echo base_url()."admin/programs/deleteAll"; ?>',
         data:{
            allIds : ids,
