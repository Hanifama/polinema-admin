          ...
          <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="box-body">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="category" name="category" value="<?php echo (isset($default))?$default['category']:set_value('category'); ?>" <?php echo (isset($default))?"readonly":""; ?>>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="sub_category" name="sub_category" value="<?php echo (isset($default))?$default['sub_category']:set_value('sub_category'); ?>" <?php echo (isset($default))?"readonly":""; ?>>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="key" name="key" value="<?php echo (isset($default))?$default['key']:set_value('key'); ?>" <?php echo (isset($default))?"readonly":""; ?>>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <span style="margin-right:20px;">
                    <input type="radio" style="width:20px; height:20px;" name="value_type" value="text" <?php echo (set_value('value_type', 'text') == 'text') ? 'checked' : ''; ?>> Text
                  </span>
                  <span style="margin-right:20px;">
                    <input type="radio" style="width:20px; height:20px;" name="value_type" value="image" <?php echo (set_value('value_type') == 'image') ? 'checked' : ''; ?>> Image
                  </span>
                </div>
              </div>
              ...
              <div class="form-group mb-3" id="value_text_group" style="display:none;">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" id="value_text" name="value_text"><?php echo set_value("value_text"); ?></textarea>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3" id="value_image_group" style="display:none;">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" id="value_image_url" name="value_image_url" value="<?php echo set_value("value_image_url"); ?>">
                  <br>
                  <img id="preview_image" src="" alt="Preview Image" style="max-width:150px; max-height:150px; display:none;">
                </div>
                <div class="col-sm-4">
