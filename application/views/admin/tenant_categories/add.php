...
<div class="row">
  <div class="animated fadeInRight">
	...
	<div class="form-group mb-3" style="display:none" >
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="tencat_id" readonly name="tencat_id" value="<?php echo md5(uniqid(mt_rand(), true)) ?>" >
	  </div>
	  <div class="col-sm-6" >
    ...
    <div class="form-group mb-3">
      ...
      <input type="hidden" name="old_icon" value="<?php if (isset($icon) && $icon!=""){echo $icon; } ?>" />
