...
<div class="form-group mb-3" style="display:none">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" id="tenant_id" readonly name="tenant_id" value="<?php echo set_value("tenant_id",html_entity_decode($tenants->tenant_id)); ?>">
  </div>
  <div class="col-sm-4" >
...
<!-- Tenant_id End -->
	...
	<div class="form-group mb-3">
      ...
      foreach($tenant_categories as $key => $value): ?>
            <option value="<?php echo $value->tencat_id; ?>" <?php echo $value->tencat_id==$tenants->tencat_id?'selected="selected"':""; ?>>
            <?php echo $value->name; ?>
          </option>
      <?php endforeach; ?>
      <?php endif; ?>
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" id="name" name="name" value="<?php echo set_value("name",html_entity_decode($tenants->name)); ?>">
  </div>
  <div class="col-sm-4" >
...
<!-- Name End -->
    ...
    <div class="form-group mb-3">
      ...
      value="<?php if (isset($banner) && $banner!=""){echo $banner; }?>" />  
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <textarea class="form-control" id="address" name="address"><?php echo set_value("address",html_entity_decode($tenants->address)); ?></textarea>
  </div>
  <div class="col-sm-4" >
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <textarea class="form-control" id="about" name="about"><?php echo set_value("about",html_entity_decode($tenants->about)); ?></textarea>
  </div>
  <div class="col-sm-4" >
...
<!-- About End -->    <!-- Image_1 Start -->
    ...
    <div class="form-group mb-3">
      ...
      <input type="hidden" name="old_image_1" 

      value="<?php if (isset($image_1) && $image_1!=""){echo $image_1; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $tenants->image_1; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group mb-3">
      ...
      <input type="hidden" name="old_image_2" 

      value="<?php if (isset($image_2) && $image_2!=""){echo $image_2; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $tenants->image_2; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group mb-3">
      ...
      <input type="hidden" name="old_image_3" 

      value="<?php if (isset($image_3) && $image_3!=""){echo $image_3; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $tenants->image_3; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group mb-3">
      ...
      <input type="hidden" name="old_image_4" 

      value="<?php if (isset($image_4) && $image_4!=""){echo $image_4; }?>" />  
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" id="lat" name="lat" value="<?php echo set_value("lat",html_entity_decode($tenants->lat)); ?>">
  </div>
  <div class="col-sm-4" >
...
<div class="form-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" id="lng" name="lng" value="<?php echo set_value("lng",html_entity_decode($tenants->lng)); ?>">
  </div>
  <div class="col-sm-4" >
...
<!-- Lng End -->
	 ...
	 <div class="form-group mb-3">
	          ...
	          <div class="col-sm-6">
	            ...
	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $tenants->status=="active"?'checked="checked"':""; ?> name="status" value="active"> active </span>

	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $tenants->status=="inactive"?'checked="checked"':""; ?> name="status" value="inactive"> inactive </span>
