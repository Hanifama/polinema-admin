...
<div class="row">
  <div class="animated fadeInRight">
	...
	<div class="form-group mb-3">
	  <label for="experience_id" class="col-sm-3 form-label"> ID </label>
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="experience_id" name="experience_id" readonly value="<?php echo md5(uniqid(mt_rand(), true)) ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="company_category" name="company_category" value="<?php echo set_value("company_category"); ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="position" name="position" value="<?php echo set_value("position"); ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="start_year" name="start_year" value="<?php echo set_value("start_year"); ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="end_year" name="end_year" value="<?php echo set_value("end_year"); ?>" >
	  </div>
	  <div class="col-sm-6" >
