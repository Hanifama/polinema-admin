...
<div class="row">
  <div class="animated fadeInRight">
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="user_id" name="user_id" readonly value="<?php echo md5(uniqid(mt_rand(), true)) ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="major" name="major" value="<?php echo set_value("major"); ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  <label for="year_generation" class="col-sm-3 form-label"> Year_generation </label>
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="year_generation" name="year_generation" value="<?php echo set_value("year_generation"); ?>" >
	  </div>
	  <div class="col-sm-6" >
	...
	<div class="form-group mb-3">
	  ...
	  <div class="col-sm-6">
	    <input type="text" class="form-control" id="job" name="job" value="<?php echo set_value("job"); ?>" >
	  </div>
	  <div class="col-sm-6" >
