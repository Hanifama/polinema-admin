          ...
          <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="vocat_id" name="vocat_id" readonly value="<?php echo md5(uniqid(mt_rand(), true)) ?>">
                </div>
                <div class="col-sm-6">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" name="old_icon" value="<?php if (isset($icon) && $icon != "") {
                                                                echo $icon;
                                                              } ?>" />
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" class="form-control datetimepicker" id="created_dt" name="created_dt" value="<?= date("Y-m-d H:i:s") ?>" />
                </div>
                <div class="col-sm-4">
