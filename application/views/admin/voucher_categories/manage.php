   ...
   <div class="col-lg-12">
      <div class="ibox card mt-3 ">
         ...
         <div class="ibox-title card-header">
            ...
            <a href="<?php echo base_url(); ?>admin/voucher_categories/add" class="btn btn-info m-2">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url() . 'admin/voucher_categories/index'; ?>" class="form-inline ibox-content">
               <div class="form-group m-2">
                  <select name="searchBy" class="form-control">
                     <option value="vocat_id" <?php echo $searchBy == "vocat_id" ? 'selected="selected"' : ""; ?>>ID</option>
               ...
               <table class="table table-striped table-bordered table-hover Tax" style="font-size: 13px;">
                  <thead>
                     <tr>
                        ...
                        <th> <a href="<?php echo $fields_links["created_dt"]; ?>" class="link_css"> Created <?php echo $symbol ?></a></th>                        <th> Action </th>
                     </tr>
                  </thead>
                  ...
                  <tbody>
                     ...
                     ?>
                        ...
                        ?>
                           <tr id="hide<?php echo $value->vocat_id; ?>">
                              <th><input name='input' id='del' onclick="callme('show')" type='checkbox' class='del' value='<?php echo $value->vocat_id; ?>' /></th>
                              ...
                              <th><?php if (!empty($value->icon)) { ?>
                                    ...
                                    <img src="<?php echo $this->config->item('photo_url'); ?><?php echo $value->icon; ?>" alt="pic" width="50" height="50" />
                              ...
                              <th class="action-width btn-group">
                                 ...
                                 <a href="<?php echo base_url() ?>admin/voucher_categories/edit/<?php echo $value->vocat_id; ?>" class="btn btn-info" title="Edit">
                                    <i class="fa fa-edit"></i>
                                 </a>
                                 <a title="Delete" data-toggle="modal" data-target="#commonDelete" class="btn btn-info" onclick="set_common_delete('<?php echo $value->vocat_id; ?>','voucher_categories');">
...
<script type="text/javascript">
   function delRow() {
      ...
      if (confrm) {
         ...
         $.ajax({
            type: "POST",
            url: '<?php echo base_url() . "admin/voucher_categories/deleteAll"; ?>',
            data: {
               allIds: ids,
