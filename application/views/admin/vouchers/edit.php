          ...
          <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group mb-3" style="display:none">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="voucher_id" name="voucher_id" value="<?php echo set_value("voucher_id", html_entity_decode($vouchers->voucher_id)); ?>">
                </div>
                <div class="col-sm-4">
                  ...
                  <select class="form-control select2" name="tenant_id" id="tenant_id">
                    ...
                    if (isset($tenants) && !empty($tenants)):
                      ...
                      foreach ($tenants as $key => $value): ?>
                        <option value="<?php echo $value->tenant_id; ?>" <?php echo $value->tenant_id == $vouchers->tenant_id ? 'selected="selected"' : ""; ?>>
                          <?php echo $value->name; ?>
                        </option>
                      <?php endforeach; ?>
                    <?php endif; ?>
			...
			<!-- Vocat_id Start -->
                  ...
                  <select class="form-control select2" name="vocat_id" id="vocat_id">
                    ...
                    if (isset($voucher_categories) && !empty($voucher_categories)):
                      ...
                      foreach ($voucher_categories as $key => $value): ?>
                        <option value="<?php echo $value->vocat_id; ?>" <?php echo $value->vocat_id == $vouchers->vocat_id ? 'selected="selected"' : ""; ?>>
                          <?php echo $value->name; ?>
                        </option>
                      <?php endforeach; ?>
                    <?php endif; ?>
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="title" name="title" value="<?php echo set_value("title", html_entity_decode($vouchers->title)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" id="description" name="description"><?php echo set_value("description", html_entity_decode($vouchers->description)); ?></textarea>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" name="old_banner_1"

                    value="<?php if (isset($banner_1) && $banner_1 != "") {
                              echo $banner_1;
                            } ?>" />
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" name="old_banner_2"

                    value="<?php if (isset($banner_2) && $banner_2 != "") {
                              echo $banner_2;
                            } ?>" />
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" name="old_banner_3"

                    value="<?php if (isset($banner_3) && $banner_3 != "") {
                              echo $banner_3;
                            } ?>" />
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="hidden" name="old_banner_4"

                    value="<?php if (isset($banner_4) && $banner_4 != "") {
                              echo $banner_4;
                            } ?>" />
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $vouchers->discount_type == "percentage" ? 'checked="checked"' : ""; ?> name="discount_type" value="percentage"> percentage </span>

                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $vouchers->discount_type == "fixed" ? 'checked="checked"' : ""; ?> name="discount_type" value="fixed"> fixed </span>
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="discount_value" name="discount_value" value="<?php echo set_value("discount_value", html_entity_decode($vouchers->discount_value)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="minimum_amount" name="minimum_amount" value="<?php echo set_value("minimum_amount", html_entity_decode($vouchers->minimum_amount)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="maximum_discount" name="maximum_discount" value="<?php echo set_value("maximum_discount", html_entity_decode($vouchers->maximum_discount)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <!-- Maximum_discount End -->

              <!-- Start_dt Start -->

              <div class="form-group mb-3">
                <label for="start_dt" class="col-sm-3 form-label"> Start Time </label>
                <div class="col-sm-6">
                  <input type="text" class="form-control datetimepicker" name="start_dt" id="start_dt" value="<?php echo set_value("start_dt", $vouchers->start_dt); ?>" />
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                <label for="end_dt" class="col-sm-3 form-label"> End Time </label>
                <div class="col-sm-6">
                  <input type="text" class="form-control datetimepicker" name="end_dt" id="end_dt" value="<?php echo set_value("end_dt", $vouchers->end_dt); ?>" />
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="is_claimed" name="is_claimed" value="<?php echo set_value("is_claimed", html_entity_decode($vouchers->is_claimed)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="quota" name="quota" value="<?php echo set_value("quota", html_entity_decode($vouchers->quota)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="used" name="used" value="<?php echo set_value("used", html_entity_decode($vouchers->used)); ?>">
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control datetimepicker" name="created_dt" id="created_dt" value="<?php echo set_value("created_dt", $vouchers->created_dt); ?>" />
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-sm-6">
                  ...
                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $vouchers->status == "active" ? 'checked="checked"' : ""; ?> name="status" value="active"> active </span>

                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $vouchers->status == "inactive" ? 'checked="checked"' : ""; ?> name="status" value="inactive"> inactive </span>

                  <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $vouchers->status == "expired" ? 'checked="checked"' : ""; ?> name="status" value="expired"> expired </span>
